        ...
        <section className={styles.scrollArea}>
          ...
          <FormField id='eventTitle' label='공연명'>
            <Textfield
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                setField('eventTitle', e.target.value)
              }
            />
          </FormField>
          ...
          <FormField id='scheduleDate' label='공연 일시'>
            <div className={styles.grid}>
              <Textfield
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setField('scheduleDate', e.target.value)
                }
              />
              <Textfield
                id='scheduleTime'
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setField('scheduleTime', e.target.value)
                }
              />
            </div>
          ...
          <FormField id='boothTitle'>
            <Textfield
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                setField('boothTitle', e.target.value)
              }
            />
            <Textfield
              id='boothLocation'
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                setField('boothLocation', e.target.value)
              }
            />
            <CtaButton
              type='icon'
